...
experiments = {
    # Fishervector without normalization (hog + raw (then not) + linear kernel)
    1: {'hog': True, 'raw': True, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 5, 'sigma': 1, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': False, 'fishervect': True, 'with_norm': False, 'normalize': False}, 
    2: {'hog': True, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 5, 'sigma': 1, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': False, 'fishervect': True, 'with_norm': False, 'normalize': False}, 
     # Fishervector without normalization (hog + raw (then not) + gaussian kernel)
    4: {'hog': True, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'gaussian_kernel', 'C': 5, 'sigma': 5, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': False, 'fishervect': True, 'with_norm': False, 'normalize': False}, 
    5: {'hog': True, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'gaussian_kernel', 'C': 5, 'sigma': 5, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': False, 'fishervect': True, 'with_norm': False, 'normalize': False}, 
    # Fishervector without normalization (sift + raw (then not) + linear kernel)
    6: {'hog': False, 'raw': True, 'lbp': False, 'PCA': 0, 'kernelPCA': 'gaussian_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 5, 'sigma': 10, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': True, 'fishervect': True, 'with_norm': False, 'normalize': False},
    7: {'hog': False, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'gaussian_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 5, 'sigma': 10, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': True, 'fishervect': True, 'with_norm': False, 'normalize': False},
}

# to_submit = {
#     # Best score on valid (hog and linear kernel)
#     1: {'hog': True, 'raw': True, 'lbp': True, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 1, 'sigma': 1, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 1, 'sift': True, 'fishervect': False, 'with_norm': False, 'normalize': False, 'to_submit':True},
#     # Bow with SIFT
#     2: {'hog': False, 'raw': True, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 1, 'sigma': 1, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': True, 'k': 20, 'sift': True, 'fishervect': False, 'with_norm': False, 'normalize': False, 'to_submit':True}, 
#     # Hog with chi 2 kernel
#     3: {'hog': True, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'chi2_kernel', 'C': 1, 'sigma': 0.1, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 1, 'sift': False, 'fishervect': False, 'with_norm': False, 'normalize': False, 'to_submit':True}, 
#     # Bow with sift and linear SVM
#     4: {'hog': False, 'raw': True, 'lbp': False, 'PCA': 0, 'kernelPCA': 'gaussian_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'linear_kernel', 'C': 5, 'sigma': 10, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 10, 'sift': True, 'fishervect': False, 'with_norm': False, 'normalize': False, 'to_submit':True}, 
#     # Hog with RBF
#     5: {'hog': True, 'raw': False, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'gaussian_kernel', 'C': 1, 'sigma': 2, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 1, 'sift': False, 'fishervect': False, 'with_norm': False, 'normalize': False, 'to_submit':True}, 
#     # Fishervector without normalization (hog + raw + gaussian kernel)
#     6: {'hog': True, 'raw': True, 'lbp': False, 'PCA': 0, 'kernelPCA': 'linear_kernel', 'strat': 'onevsone', 'SVM': 'CVXOPT', 'kernelSVM': 'gaussian_kernel', 'C': 5, 'sigma': 2, 'p': 1, 'subname': '1', 'gamma': 1, 'r': 1, 'bow': False, 'k': 20, 'sift': False, 'fishervect': True, 'with_norm': False, 'normalize': False, 'to_submit':True}, 
# }