...
"""Kernel SVM implementation with handlade SGD as optimizer
"""
...
"""Kernel SVM implementation with CVXOPT as optimizer
"""
...
class BinarySVM(object):
    ...
    def fit(self, X, y):
        ...
        # Support vectors corresponds to non zero alphas
        sv = a > 1e-5
